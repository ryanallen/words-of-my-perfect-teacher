...
> *Beyond being defiled by the [two obscurations](#two-obscurations),*[^122] *you purport to still be purifying them.*  
...
The main obstacles that prevent all the extraordinary experiences and realizations of the profound path from arising are [negative actions](#negative-action), [obscurations](#obscurations) and [habitual tendencies](#habitual-tendencies). (See also: [obscurations of habitual tendencies](#obscurations-of-habitual-tendencies).[^123]) Just as it is important to clean the surface of a mirror if forms are to be reflected in it, so too it is important to eliminate our [obscurations](#obscurations) so that realization can appear like a reflection in the mirror of the [Ground of All](#ground-of-all). [^124] The [Conqueror](#conqueror) taught countless methods of purification for this purpose, but the best of them all is meditation and recitation related to the teacher as [Vajrasattva](#vajrasattva).[^125][^126]
...
Like [Nanda](#nanda), [Aṅgulimāla](#aṅgulimāla), [Darśaka](#darśaka) and [Śaṅkara](#śaṅkara)[^128]  
>  
...
"Print books, then," the Master told him.[^132]
...
"Printing these texts brings up too many distractions," he said. "Is it not true that no method of confession is more profound than remaining in the essential nature?"[^133]
...
To practice the actual meditation and recitation, proceed as follows, remembering all the time the specific pure meaning[^134] of each element in the context of [the four powers](#ii-the-four-powers) as antidotes.
...
For the visualization that follows, see yourself as staying in your ordinary form.[^135] Suspended in space an arrow's length above your head, visualize an open white lotus[^136] with a thousand petals, and upon it the disc of a full moon. We say "a full moon" here not to indicate how big the disc should be, but to signify that it is perfectly round and regular and looks like the completely full moon on the fifteenth day of the lunar month. Upon this lunar disc, visualize a brilliant white syllable *hum*.[^137]

In other traditions the syllable emanates and reabsorbs rays of light,[^138] but that is not the case here.

  
In an instant the *hum* is transformed into your glorious [root teacher](#root-teacher)[^139], that incomparable mine of compassion who in [essence](#essence) is the nature of all the [Buddhas](#buddha) of past, present and future in one. He appears in the form of the [saṃbhogakāya](#saṃbhogakāya) [Buddha](#buddha),[^140] [Vajrasattva](#vajrasattva), white in color, like a snow peak lit up by a hundred thousand suns.

He has one face and two arms. With his right hand, between the palm and ring finger, he holds before his heart center the five-pronged [vajra](#vajra) of [awareness](#awareness) and [emptiness](#emptiness).[^141]

![alt text](imgs/hum-om-ah.svg)

With his left, he rests the [bell](#bell) (representing supreme [wisdom](#wisdom)) of [awareness](#awareness) and [emptiness](#emptiness) at his left hip.[^142] [^143]

His two legs are crossed in the [[vajra](#vajra) posture](#vajra-posture) and he is adorned with the thirteen ornaments of the [saṃbhogakāya](#saṃbhogakāya)&mdash;the **five silken garments**[^144] and **eight jewels**[^145] [^146].
...
Keeping in mind the pure meaning of the visualization,[^134] recite the root text, starting from:
...
Then, in the heart of [Vajrasattva](#vajrasattva), who is indivisibly united with his [consort](#consort), visualize a lunar disc no bigger than a flattened mustard seed, and upon it a white *hum*, as fine as if it had been drawn with a single hair. As you recite the hundred syllable [mantra](#mantra) once, "Om [Vajrasattva](#vajrasattva) [Samaya](#samaya)..."[^149] and so on, visualize its syllables arranged around the *hum* in a circle. None of them touch each other, like the horns of cattle when they stand close together.[^150] Then recite the [hundred syllables](#hundred-syllables) as a prayer, imagining at the same time that a [nectar](#nectar) of compassion and [wisdom](#wisdom) drips down from each of the syllables, one glistening drop after another, like water dripping down from ice as it melts near a fire. Pouring down through the body of [Vajrasattva](#vajrasattva), the [nectar](#nectar) emerges from the point of union of the [deity](#deity) and [consort](#consort), and, passing through the crown of your head, flows into you, and into all other sentient beings too.
...
> *... I beg you, cleanse and purify me!*[^152]
...
> Fortunate one, all your [negative action](#negative-action)s, [obscurations](#obscurations), violations and breaches are purified.[^153]
...
[^122]: The <a href="#obscurations">obscurations</a> of <a href="#negative-emotions">negative emotions</a> and <a href="#concept-obscurations">conceptual obscurations</a>. "<a href="#obscurations">Obscurations</a>" <a href="#means">means</a> factors that cover and obscure our <a href="#buddha-nature">Buddha nature</a>.

[^123]: Habitual patterns created by past actions.
